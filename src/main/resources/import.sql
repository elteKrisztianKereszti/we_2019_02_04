...
insert into issue (title, description, place, status, created_at, updated_at, user_id) values ('issue1', 'description1', 'PC-01', 'NEW', CURRENT_TIMESTAMP(),  CURRENT_TIMESTAMP(), 2);
insert into issue (title, description, place, status, created_at, updated_at, user_id) values ('issue2', 'description2', 'PC-02', 'DOING', CURRENT_TIMESTAMP(),  CURRENT_TIMESTAMP(), 2);
insert into issue (title, description, place, status, created_at, updated_at, user_id) values ('issue3', 'description3', 'PC-03', 'DOING', CURRENT_TIMESTAMP(),  CURRENT_TIMESTAMP(), 2);
insert into issue (title, description, place, status, created_at, updated_at, user_id) values ('issue4', 'description4', 'PC-04', 'DONE', CURRENT_TIMESTAMP(),  CURRENT_TIMESTAMP(), 1);
